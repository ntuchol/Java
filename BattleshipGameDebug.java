/*
 * BattleshipGameDebug.java - the main class for a program for playing the
 * game of Battleship.
 * 
 * Computer Science 111, Boston University
 * 
 * NOTE: This version of the BattleshipGame class includes
 * additional lines of code that print each player's
 * collection of ships after printing the player's board.
 * This should allow you to more easily debug your
 * addShip(), removeShip(), and printShips() methods.
 */

import java.util.*;

public class BattleshipGameDebug {
    ...
    public static void main(String[] args) {
        ...
        BattleshipGameDebug game = new BattleshipGameDebug();
    ...
    public void initialize(Scanner console) {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                this.players[0] = new Player("you");
                
                // computer player
                this.boards[1] = new HiddenShipsBoard(DIMENSION);
                this.players[1] = new Player("the computer");
                ...
                this.players[1] = new Player("player 1");
    ...
    public static void addShipsTo(Player player, Board board) {
        ...
        addShipTo(new Ship("Tanker", 3), player, board);
    ...
    public void displayBoards(Scanner console) {
        ...
        System.out.println("** ships belonging to " + this.players[0] + ":");
        this.players[0].printShips();
        System.out.println();
        
        System.out.println(this.players[1] + ":");
        this.boards[1].display();
        System.out.println("** ships belonging to " + this.players[1] + ":");
